...
export function LeadMagnetBanner() {
  ...
  return (
    <section className="bg-ink-dark px-6 py-16" aria-labelledby="lead-magnet-heading">
      <div className="from-primary/20 to-primary-container/10 border-primary/20 space-y-6 rounded-3xl border bg-gradient-to-br p-8">
